...
const permCategories = {
  view: ['statementRead', 'deliveryViewDetail', 'costView', 'costViewStandard', 'inboundViewCost', 'receivableView', 'payableView', 'workflowView', 'productionViewBom', 'supplierView'],
  create: ['canCreateQuote', 'canCreateContract', 'inboundCreate', 'outboundCreate', 'warehouseCreate', 'statementCreate', 'deliveryCreate', 'purchaseCreate', 'supplierCreate', 'receivableCreate', 'payableCreate', 'receiptCreate', 'paymentCreate', 'stocktakingCreate', 'transferCreate', 'productionCreate'],
  ...
  special: ['inboundInspect', 'outboundCancel', 'outboundReverse', 'statementVoid', 'statementPay', 'purchaseOrder', 'purchaseReceive', 'purchaseInspect', 'purchaseComplete', 'purchaseCancel', 'supplierEvaluate', 'supplierBlacklist', 'workflowDelegate', 'workflowAddApprover', 'workflowCancel', 'workflowDesign', 'stocktakingExecute', 'stocktakingAdjust', 'transferShip', 'transferReceive', 'productionRelease', 'productionStart', 'productionQualityCheck', 'productionComplete', 'productionCancel', 'productionIssueMaterial', 'receivableAging', 'payableAging']
}
