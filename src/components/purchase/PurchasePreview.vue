...
<script setup>
import { ref } from 'vue'
import { STATUS_LABELS } from '@/stores/purchase'
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .print-info-grid { display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 8px; }
            .print-info-item { font-size: 13px; }
            .print-info-label { color: #888; }
            .print-info-value { font-weight: 500; }
            .print-title { font-size: 16px; font-weight: 600; margin: 15px 0; text-align: center; }
            ...
            .print-table tfoot td { border-top: 2px solid #333; }
            .print-section { margin-bottom: 15px; }
            .print-notes { font-size: 13px; color: #555; margin-top: 4px; white-space: pre-wrap; }
            .print-signatures { display: flex; justify-content: space-between; margin-top: 40px; padding-top: 20px; }
            .print-sign-block { display: flex; align-items: center; gap: 8px; }
