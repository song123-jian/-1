...
.upload-text { font-size: var(--font-size-base); font-weight: 600; color: var(--color-text-primary); margin-bottom: 4px; }
.upload-hint { font-size: var(--font-size-sm); color: var(--color-text-tertiary); }
.ai-parsing-hint { text-align: center; padding: 8px; color: var(--color-accent); font-size: var(--font-size-sm); margin-top: 8px; }
</style>
