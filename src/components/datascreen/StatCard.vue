  ...
  <div class="ds-stat-card" :style="{ '--card-color': color }">
    ...
    <div class="ds-stat-card__content">
      ...
      <div class="ds-stat-card__footer">
        ...
        <div class="ds-stat-card__sparkline" v-if="sparkline.length > 1">
          <svg :width="sparkWidth" :height="sparkHeight" :viewBox="`0 0 ${sparkWidth} ${sparkHeight}`">
            ...
            <path :d="sparkLinePath" fill="none" :stroke="color" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            <circle :cx="sparkLastPoint.x" :cy="sparkLastPoint.y" r="2.5" :fill="color" class="ds-stat-card__spark-dot" />
          </svg>
        </div>
      </div>
    </div>
