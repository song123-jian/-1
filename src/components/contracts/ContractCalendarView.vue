...
.calendar-cell { background: var(--color-surface); min-height: 90px; padding: 4px; transition: background 0.2s; }
...
.calendar-event { display: flex; align-items: center; gap: 4px; padding: 2px 4px; font-size: 11px; cursor: pointer; border-radius: 3px; transition: transform 0.15s, background 0.15s; color: var(--color-text-primary); }
...
.week-event { padding: 6px 8px; margin-bottom: 6px; border-radius: var(--radius-sm); border-left: 3px solid var(--color-border); cursor: pointer; transition: all 0.15s; }
