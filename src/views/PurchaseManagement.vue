  ...
  <div class="purchase-management-page">
    ...
    <div class="tab-view-row">
      ...
      <div v-if="activeTab === 'list'" class="view-toggle">
        <button class="view-toggle-btn" :class="{ active: viewMode === 'table' }" @click="viewMode = 'table'" title="表格视图"><Icon name="chart" :size="14" /></button>
        <button class="view-toggle-btn" :class="{ active: viewMode === 'list' }" @click="viewMode = 'list'" title="列表视图"><Icon name="list" :size="14" /></button>
        <button class="view-toggle-btn" :class="{ active: viewMode === 'card' }" @click="viewMode = 'card'" title="卡片视图"><Icon name="card" :size="14" /></button>
      </div>
    </div>
    ...
    <div v-show="activeTab === 'list' && viewMode === 'list'" class="panel-card">
      ...
      <div class="panel-card-body">
        <div v-if="filteredOrders.length > 0">
          <div v-for="(order, idx) in filteredOrders" :key="order.id" class="purchase-list-item" :style="{ animationDelay: idx * 50 + 'ms' }" @click="openPreview(order)">
    ...
    <div v-show="activeTab === 'list' && viewMode === 'card'" class="panel-card">
      ...
      <div class="panel-card-body">
        <div v-if="filteredOrders.length > 0" class="purchase-card-grid">
          <div v-for="(order, idx) in filteredOrders" :key="order.id" class="purchase-card-item" :style="{ animationDelay: idx * 60 + 'ms' }" @click="openPreview(order)">
