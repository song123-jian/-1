...
.rank-panel__body::-webkit-scrollbar {
  width: 4px;
}
.rank-panel__body::-webkit-scrollbar-thumb {
...
.rank-panel__rank.gold {
  background: linear-gradient(135deg, #ffd700, #ffaa00);
  color: #1a1a2e;
  box-shadow: 0 0 12px rgba(255, 215, 0, 0.3);
}
.rank-panel__rank.silver {
  background: linear-gradient(135deg, #c0c0c0, #a0a0a0);
  color: #1a1a2e;
}
.rank-panel__rank.bronze {
