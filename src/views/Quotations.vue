        ...
        <div class="panel-card-body no-padding">
          <div class="table-container">
            <table class="data-table">
              ...
              <tbody>
                <tr v-if="pagedQuotations.length === 0"><td :colspan="2 + visibleColCount" class="empty-state"><div class="empty-state-icon"><Icon name="empty" :size="24" /></div>暂无报价数据</td></tr>
...
.list-item { display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-bottom: 1px solid var(--color-border); cursor: pointer; transition: all 0.2s ease; animation: listSlideIn 0.3s ease-out both; }
