          ...
          <table class="data-table">
            ...
            <tbody>
              ...
              <tr v-for="log in filteredLogs" :key="log.id">
                <td style="font-size:var(--font-size-xs);overflow-wrap:break-word;word-wrap:break-word">{{ formatTime(log.createdAt) }}</td>
                <td><span class="status-badge" :class="logActionClass(log.action)">{{ logActionLabel(log.action) }}</span></td>
                <td style="font-size:var(--font-size-xs);overflow-wrap:break-word;word-wrap:break-word">{{ log.description }}</td>
                <td style="font-size:var(--font-size-xs);overflow-wrap:break-word;word-wrap:break-word">{{ log.operator }}</td>
              </tr>
            </tbody>
          </table>
        </div>
