            ...
            <tbody>
              <template v-for="mod in filteredModules" :key="mod.key">
                <tr class="module-header-row" style="cursor:pointer" @click="toggleModuleExpand(mod.key)">
                  <td style="font-weight:600;position:sticky;left:0;background:var(--color-surface-elevated);z-index:1;overflow-wrap:break-word;word-wrap:break-word">
                ...
                <tr v-for="perm in mod.perms" :key="mod.key + '.' + perm" v-show="expandedModules.has(mod.key)">
                  <td style="padding-left:var(--space-6);position:sticky;left:0;background:var(--color-surface);z-index:1;overflow-wrap:break-word;word-wrap:break-word">
...
.module-header-row td {font-weight: 600;
  border-bottom: 2px solid var(--color-border); overflow-wrap: break-word; word-wrap: break-word}
.perm-matrix-table td{overflow-wrap: break-word; word-wrap: break-word}
.perm-matrix-table th {overflow-wrap: break-word; word-wrap: break-word}
.perm-category-badge {
