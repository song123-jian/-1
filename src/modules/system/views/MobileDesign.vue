          ...
          <div class="panel-card-body">
            ...
            <div style="margin-bottom:var(--space-3)">
              ...
              <div v-for="(val, key) in currentSpec.typography" :key="key" style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;font-size:12px">
                ...
                <span style="font-family:var(--font-mono);color:var(--color-text-primary)">{{ val.split('/')[0] }} / {{ val.split('/')[1] || '400' }}</span>
              </div>
            </div>
            <div style="margin-bottom:var(--space-3)">
              ...
              <div style="display:flex;gap:4px;align-items:flex-end">
                <div v-for="(val, key) in currentSpec.spacing" :key="key" style="text-align:center;flex:1">
                  ...
                  <div style="font-size:10px;font-family:var(--font-mono);color:var(--color-text-primary)">{{ val }}</div>
                </div>
              </div>
            </div>
            <div style="margin-bottom:var(--space-3)">
            ...
            <div>
              ...
              <div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;font-size:12px">
                ...
                <span style="font-family:var(--font-mono);color:var(--color-text-primary)">{{ currentSpec.animation.duration }}</span>
              </div>
              <div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;font-size:12px">
                <span style="color:var(--color-text-secondary)">缓动函数</span>
                <span style="font-family:var(--font-mono);color:var(--color-text-primary);font-size:10px">{{ currentSpec.animation.easing }}</span>
              </div>
            </div>
          </div>
        </div>
...
.phone-status-bar {
  display: flex; justify-content: space-between; padding: var(--space-1) var(--space-3);
...
.phone-nav-item { display: flex; flex-direction: column; align-items: center; gap: var(--space-1); }
