<template>
  <div class="panel-card" style="margin-top: var(--space-4)">
    ...
    <div class="panel-card-body">
      <div
        style="display: grid; grid-template-columns: repeat(4, 1fr); gap: var(--space-4); margin-bottom: var(--space-4)"
      >
        <div
          style="
        ...
        >
          ...
          <div style="font-size: var(--font-size-2xl); font-weight: 700; color: var(--color-danger)">
      ...
      <div style="padding: var(--space-3); background: var(--color-bg-primary); border-radius: var(--radius-md)">
        ...
        <div style="font-size: var(--font-size-xs); color: var(--color-text-tertiary)">
          系统运行正常，所有指标均在正常范围内。建议定期备份数据以保持系统稳定性。
        </div>
      </div>
    </div>
  </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: var(--space-3)">
      <div style="background: var(--color-surface-elevated); padding: var(--space-3); border-radius: var(--radius-md)">
        ...
        <div style="font-size: var(--font-size-xl); font-weight: 700; color: var(--color-success)">
          {{ perfMetrics.loadTime }}ms
        </div>
      </div>
      <div style="background: var(--color-surface-elevated); padding: var(--space-3); border-radius: var(--radius-md)">
        <div style="font-size: var(--font-size-xs); color: var(--color-text-secondary)">内存使用</div>
        <div style="font-size: var(--font-size-xl); font-weight: 700; color: var(--color-accent)">
          {{ perfMetrics.memoryUsage }}MB
        </div>
      </div>
      <div style="background: var(--color-surface-elevated); padding: var(--space-3); border-radius: var(--radius-md)">
        ...
        <div style="font-size: var(--font-size-xl); font-weight: 700; color: var(--color-info)">
          {{ perfMetrics.apiResponseTime }}ms
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="settings-card" style="margin-top: var(--space-4)">
    ...
    <div style="padding: var(--space-3); background: var(--color-surface-elevated); border-radius: var(--radius-md)">
      <div style="font-size: var(--font-size-sm); color: var(--color-text-tertiary)">
        审计日志记录所有关键操作的详细信息，包括操作人、操作时间、操作内容和结果。
      </div>
...
<script>
export default { name: 'SystemHealth' }
</script>
<script setup>
