...
function normalizeSupplierList(data) {
  const list = Array.isArray(data) ? data.map((item) => ({ ...item })) : []

  for (const supplier of list) {
    if (!supplier.code) {
      supplier.code = generateSupplierCode(list)
    }
  }
...
export const useSupplierStore = defineStore('supplier', () => {
  const suppliers = ref(normalizeSupplierList(load(STORAGE_KEY, [])))
  ...
  function previewNextSupplierCode() {
    return generateSupplierCode(suppliers.value)
  }
  ...
  function initSeedData() {
    ...
    suppliers.value = [
      ...
      /* 以下供应商用于测试重复数据检测 */
      {
        ...
        contact: '王经理',
        phone: '021-5888XXXX',
        email: 'wang@sh-steel.com',
        address: '上海市宝山区钢铁大道1号',
        bankName: '工商银行上海宝山支行',
        bankAccount: '6222000000000000007',
        qualification: 'ISO9001',
        qualificationExpiry: '2027-06-30',
        rating: 5,
        deliveryScore: 92,
      ...
      },
      {
        ...
        contact: '王经理',
        phone: '021-5888XXXX',
        email: 'wang@sh-steel-ltd.com',
        address: '上海市宝山区钢铁大道2号',
        bankName: '建设银行上海宝山支行',
        bankAccount: '6222000000000000008',
        qualification: 'ISO9001',
        qualificationExpiry: '2027-03-15',
        rating: 4,
        deliveryScore: 82,
      ...
      },
      {
        ...
        contact: '李总监',
        phone: '0755-8888XXXX',
        email: 'li@sz-elec.com',
        address: '深圳市福田区华强北路',
        bankName: '招商银行深圳分行',
        bankAccount: '6222000000000000009',
        qualification: 'ISO14001',
        qualificationExpiry: '2027-05-10',
        rating: 5,
        deliveryScore: 90,
        qualityScore: 93,
      ...
      },
      {
        ...
        contact: '赵总',
        phone: '010-6222XXXX',
        email: 'zhao@bj-mech.com',
        address: '北京市通州区工业开发区',
        bankName: '北京银行通州支行',
        bankAccount: '6222000000000000010',
        qualification: 'TS16949',
        qualificationExpiry: '2026-09-30',
        rating: 4,
        deliveryScore: 80,
        qualityScore: 85,
  ...
  function addSupplier(data) {
    ...
    supplier.code = supplier.code || generateSupplierCode(suppliers.value)
  ...
  function updateSupplier(id, data) {
    ...
    if (idx !== -1) {
      const updated = { ...suppliers.value[idx], ...data }
      updated.code = updated.code || suppliers.value[idx].code || generateSupplierCode(suppliers.value)
  ...
  function replaceData(data) {
    suppliers.value = normalizeSupplierList(data)
    persist()
  }
