...
.overview-rating-stars { display: flex; gap: var(--space-1); }
.overview-rating-dims { display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-1) var(--space-3); margin-top: var(--space-1); }
.rating-dim { font-size: var(--font-size-xs); color: var(--color-text-secondary); display: flex; align-items: center; gap: var(--space-1); }
...
.alert-dot { display: inline-block; width: 8px; height: 8px; border-radius: 50%; background: var(--color-warning); animation: alertDotPulse 1.5s ease-in-out infinite; margin-right: var(--space-1); }
...
.alert-qual-badge { padding: var(--space-1) var(--space-2); border-radius: var(--radius-full); font-size: var(--font-size-xs); font-weight: 600; }
...
/* 视图切换 */
.view-toggle { display: flex; gap: var(--space-1); background: var(--color-bg-tertiary); border-radius: var(--radius-md); padding: var(--space-1); }
...
.supplier-card-meta span { display: flex; align-items: center; gap: var(--space-1); }
...
.supplier-card-scores { display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-1) var(--space-2); }
.mini-score { font-size: var(--font-size-xs); color: var(--color-text-secondary); display: flex; align-items: center; gap: var(--space-1); }
