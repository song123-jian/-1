  ...
  <div class="transfer-page">
    ...
    <div class="flow-board">
      <template v-for="(step, idx) in flowBoardSteps" :key="step.status">
        ...
        <span v-if="idx < flowBoardSteps.length - 1" class="flow-board-arrow"><Icon name="chevronRight" :size="14" /></span>
      </template>
    </div>
    ...
    <div class="collapsible-stats">
      <div class="collapsible-stats-header" @click="showTransferStatsExpanded = !showTransferStatsExpanded">
        <span class="collapsible-stats-title"><Icon name="barChart" :size="14" /> 统计与概览</span>
        ...
        <table class="data-table">
          ...
          <tbody>
            <tr v-if="pagedOrders.length === 0">
              <td colspan="11" class="empty-state"><div class="empty-state-icon"><Icon name="shuffle" :size="24" /></div>暂无调拨单</td>
            </tr>
