<template>
  <div class="preview-related">
    <div class="related-section">
      <div class="related-section-title"><Icon name="list" :size="14" /> 关联报价单</div>
    ...
    <div class="related-section">
      <div class="related-section-title"><Icon name="truck" :size="14" /> 关联交付单</div>
    ...
    <div class="related-section">
      <div class="related-section-title"><Icon name="dollar" :size="14" /> 关联回款单</div>
...
.related-doc-item { display: flex; align-items: center; gap: var(--space-3); padding: var(--space-2) var(--space-3); border: 1px solid var(--color-border); border-radius: var(--radius-md); margin-bottom: var(--space-2); transition: background 0.15s; cursor: pointer; }
...
.related-doc-header { display: flex; align-items: center; gap: var(--space-2); margin-bottom: var(--space-1); }
