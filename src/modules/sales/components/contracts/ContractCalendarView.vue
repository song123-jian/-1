...
.calendar-grid { display: grid; grid-template-columns: repeat(7, 1fr); gap: var(--space-1); background: var(--color-border); border: 1px solid var(--color-border); border-radius: var(--radius-md); overflow: hidden; }
.calendar-header { padding: var(--space-2); text-align: center; font-weight: 600; font-size: 12px; color: var(--color-text-secondary); background: var(--color-bg-secondary); }
...
.calendar-more { font-size: 10px; color: var(--color-text-tertiary); padding: var(--space-1) var(--space-1); }
...
.week-column-header { padding: var(--space-2); text-align: center; border-bottom: 1px solid var(--color-border); background: var(--color-bg-secondary); border-radius: var(--radius-md) var(--radius-md) 0 0; }
...
.week-column-body { flex: 1; padding: var(--space-2); overflow-y: auto; }
.week-empty { text-align: center; color: var(--color-text-tertiary); font-size: 12px; padding: var(--space-5) 0; }
.week-event { padding: var(--space-2) var(--space-2); margin-bottom: var(--space-2); border-radius: var(--radius-sm); border-left: 3px solid var(--color-border); cursor: pointer; transition: all 0.15s; }
.week-event:hover { background: var(--color-bg-secondary); transform: translateX(2px); }
...
.week-event-header { display: flex; align-items: center; gap: var(--space-1); font-size: 12px; margin-bottom: var(--space-1); color: var(--color-text-primary); }
