      ...
      <div class="modal-dialog">
        ...
        <div class="modal-body">
          ...
          <div style="max-height:300px;overflow-y:auto">
            <div v-if="!currentQuote?.followUps?.length" style="text-align:center;padding:20px;color:var(--color-text-tertiary)">暂无跟进记录</div>
...
.follow-up-item { padding: var(--space-2); border-left: 3px solid var(--color-accent); margin-bottom: var(--space-2); background: var(--color-bg-tertiary); border-radius: 0 var(--radius-sm) var(--radius-sm) 0; }
.follow-up-date { font-size: var(--font-size-sm); font-weight: 600; }
.follow-up-by { color: var(--color-text-tertiary); font-weight: 400; }
.follow-up-note { font-size: var(--font-size-sm); color: var(--color-text-secondary); }
