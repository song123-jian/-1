    ...
    <div class="analytics-kpis">
      ...
      <div class="kpi-card">
        <div class="kpi-value">
          ...
          ¥{{ formatNumber(quotationStore.avgQuoteAmount) }}
        </div>
        <div class="kpi-label">平均报价金额</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-value text-warning">
          <Icon name="check" :size="14" />
          ¥{{ formatNumber(quotationStore.acceptedAmount) }}
        </div>
        <div class="kpi-label">已接受金额</div>
      </div>
    </div>
...
<script>
export default { name: 'QuotationAnalytics' }
</script>
<script setup>
