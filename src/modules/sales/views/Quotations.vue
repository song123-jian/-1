  ...
  <div class="quotation-page">
    <div class="quotation-page-inner">
      ...
      <div class="quotation-stats-bar">
        <div class="stats-ring-section" style="cursor: pointer" title="点击筛选已接受报价" @click="handleRingClick">
        ...
        <div class="stats-items">
          <div class="stat-item">
            ...
            <span class="stat-trend" :class="'trend-' + statsTrends.total.trend">
              {{ statsTrends.total.trend === 'up' ? '↑' : statsTrends.total.trend === 'down' ? '↓' : '→'
              }}{{ Math.abs(statsTrends.total.pct) }}%
            </span>
          ...
          <div class="stat-item">
            ...
            <span class="stat-trend" :class="'trend-' + statsTrends.draft.trend">
              {{ statsTrends.draft.trend === 'up' ? '↑' : statsTrends.draft.trend === 'down' ? '↓' : '→'
              }}{{ Math.abs(statsTrends.draft.pct) }}%
            </span>
          ...
          <div class="stat-item">
            ...
            <span class="stat-trend" :class="'trend-' + statsTrends.pending.trend">
              {{ statsTrends.pending.trend === 'up' ? '↑' : statsTrends.pending.trend === 'down' ? '↓' : '→'
              }}{{ Math.abs(statsTrends.pending.pct) }}%
            </span>
          ...
          <div class="stat-item">
            ...
            <span class="stat-trend" :class="'trend-' + statsTrends.approved.trend">
              {{ statsTrends.approved.trend === 'up' ? '↑' : statsTrends.approved.trend === 'down' ? '↓' : '→'
              }}{{ Math.abs(statsTrends.approved.pct) }}%
            </span>
