...
@keyframes relatedSlideIn { from { opacity: 0; transform: translateX(-6px); } to { opacity: 1; transform: translateX(0); } }
...
@keyframes todayPulse { 0%, 100% { box-shadow: 0 0 0 0 rgba(59, 130, 246, 0); } 50% { box-shadow: 0 0 8px rgba(59, 130, 246, 0.4); } }
.cell-date {
  font-size: var(--font-size-xs);
  font-weight: 600;
  color: var(--color-text-secondary);
