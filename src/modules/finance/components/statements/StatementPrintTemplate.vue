...
.print-info-table td {padding: var(--space-1) var(--space-2);
  border: 1px solid #999;
  font-size: 11px; overflow-wrap: break-word; word-wrap: break-word}
.print-parties {
  display: grid;
...
.print-items-table th{border: 1px solid #999;
  padding: var(--space-1) var(--space-2);
  text-align: left;
  font-size: 11px; overflow-wrap: break-word; word-wrap: break-word}
.print-items-table td {border: 1px solid #999;
  padding: var(--space-1) var(--space-2);
  text-align: left;
  font-size: 11px; overflow-wrap: break-word; word-wrap: break-word}
