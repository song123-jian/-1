...
export const usePayableStore = defineStore('payable', () => {
  ...
  /* 统计计算 */
  const totalAmount = computed(() => payables.value.reduce((s, p) => s + (parseFloat(p.amount) || 0), 0))
  const totalPaid = computed(() => payables.value.reduce((s, p) => s + (parseFloat(p.paidAmount) || 0), 0))
  ...
  function addPayment(data) {
    ...
    const item = {
      ...
      paymentDate: data.paymentDate || toLocalDateStr(),
  ...
  function initSeedData() {
    ...
    payables.value = [
      {
        id: 'py1',
        payableNo: 'YF20260410001',
        supplierId: 's1',
        supplierName: '江苏钢铁集团有限公司',
        sourceType: 'purchase',
        sourceId: '',
        sourceNo: 'PO-2026-001',
        amount: 90000,
        paidAmount: 90000,
        remainingAmount: 0,
        dueDate: '2026-05-10',
      ...
      {
        id: 'py2',
        payableNo: 'YF20260415001',
        supplierId: 's2',
        supplierName: '浙江化工原料有限公司',
        sourceType: 'purchase',
        sourceId: '',
        sourceNo: 'PO-2026-002',
        amount: 56000,
        paidAmount: 30000,
      ...
      {
        id: 'py3',
        payableNo: 'YF20260501001',
        supplierId: 's3',
        supplierName: '广东有色金属有限公司',
        sourceType: 'inbound',
        sourceId: 'w4',
        sourceNo: 'RK20260519002',
        amount: 125000,
        paidAmount: 0,
      ...
      {
        id: 'py4',
        payableNo: 'YF20260510001',
        supplierId: 's1',
        supplierName: '江苏钢铁集团有限公司',
        sourceType: 'contract',
        sourceId: '',
        sourceNo: 'HT-2026-PO-001',
        amount: 78000,
        paidAmount: 0,
      ...
      {
        id: 'py5',
        payableNo: 'YF20260515001',
        supplierId: 's4',
        supplierName: '山东机械制造有限公司',
        sourceType: 'purchase',
        sourceId: '',
        sourceNo: 'PO-2026-005',
        amount: 35000,
        paidAmount: 15000,
      ...
      {
        id: 'py6',
        payableNo: 'YF20260520001',
        supplierId: 's2',
        supplierName: '浙江化工原料有限公司',
        sourceType: 'purchase',
        sourceId: '',
        sourceNo: 'PO-2026-006',
        amount: 48000,
        paidAmount: 0,
