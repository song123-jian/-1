    ...
    <template v-else>
      <div class="page-header">
        <div>
          ...
          <p class="page-header-subtitle">对比实际成本与标准成本，快速定位差异原因</p>
        </div>
...
const showCostStatsExpanded = ref(false)
...
const waterfallItems = computed(() => {
  const items = supplierBreakdown.value.slice(0, 6)
