...
.page-header-subtitle { font-size: var(--font-size-sm); color: var(--color-text-tertiary); margin: var(--space-1) 0 0; }
...
/* Tab 切换 */
.detail-tabs { display: flex; gap: var(--space-1); border-bottom: 2px solid var(--color-border); margin-bottom: var(--space-3); }
...
.detail-table th { text-align: left; padding: var(--space-2) var(--space-2); color: var(--color-text-tertiary); border-bottom: 1px solid var(--color-border); font-weight: 600; background: var(--color-surface-elevated); }
.detail-table td {padding: var(--space-2) var(--space-2); border-bottom: 1px solid var(--color-border); color: var(--color-text-primary); overflow-wrap: break-word; word-wrap: break-word}
