  ...
  <div class="tagcategory-page">
    <div class="page-header">
      ...
      <div class="page-header-actions">
        ...
        <button class="btn btn-ghost" @click="openAddGroupModal">
    ...
    <div v-for="group in displayGroups" :key="group.name" class="tag-group-section">
      <div class="tag-group-header">
        ...
        <button class="btn btn-ghost btn-sm" title="删除分组" @click="confirmDeleteGroup(group.name)">
      ...
      <div class="tag-group-body">
        ...
        <div v-for="tag in group.tags" :key="tag.id" class="tag-item" :style="{ borderLeftColor: tag.color }">
          <div class="tag-item-left">
            <span class="tag-item-preview" :style="{ background: tag.color + '20', color: tag.color }">
              {{ tag.name }}
            </span>
          ...
          <div class="tag-item-right">
            ...
            <button class="btn btn-ghost btn-sm" @click="openEditModal(tag)">
              <Icon name="edit" :size="14" />
              编辑
            </button>
            <button class="btn btn-ghost btn-sm danger" @click="confirmDeleteTag(tag)">
              <Icon name="delete" :size="14" />
              删除
            </button>
          </div>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="color-picker-row">
                ...
                <input
                  ...
                  type="text"
                  class="form-input"
                  style="width: 100px; margin-left: var(--space-2)"
                  placeholder="#000000"
                />
              </div>
            </div>
            ...
            <div v-if="tagForm.name || tagForm.id" class="tag-preview-area">
              ...
              <span class="tag-item-preview" :style="{ background: tagForm.color + '20', color: tagForm.color }">
                {{ tagForm.name || tagForm.id }}
              </span>
            </div>
          </div>
...
<script>
export default { name: 'TagCategory' }
</script>
<script setup>
...
const displayGroups = computed(() => {
  ...
  return groups
    ...
    .filter((g) => g.tags.length > 0 || filterGroup.value === g.name)
})
...
function openEditModal(tag) {
  ...
  Object.assign(tagForm, {
    ...
    name: tag.name,
    color: tag.color,
    group: tag.group || tagGroups.value[0] || '关系'
  })
  showTagModal.value = true
}
