...
export const useCustomerStore = defineStore('customer', () => {
  ...
  function initSeedData() {
    ...
    customers.value = [
      ...
      {
        id: 'c7',
        customerNo: 'KH-2024-0005',
        name: '上海贸易有限公司浦东分公司',
        fullName: '上海贸易有限公司浦东分公司',
        shortName: '上海贸易浦东',
        contact: '张经理',
        contactName: '张经理',
        phone: '021-5888XXXX',
        email: 'zhang.pudong@shanghai-trade.com',
        region: '华东',
        level: 'A',
        decisionAuthority: '决策者',
        coreConcerns: '交货速度',
      ...
      },
      {
        ...
        contactName: '张经理',
        phone: '021-58881234',
        email: 'zhang@shanghai-trade-ltd.com',
        region: '华东',
        level: 'B',
        decisionAuthority: '决策者',
        coreConcerns: '价格优势',
