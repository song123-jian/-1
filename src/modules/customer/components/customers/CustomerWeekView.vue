...
.cust-week-num { font-size: var(--font-size-lg); font-weight: 700; color: var(--color-text-primary); margin-top: var(--space-1); }
.cust-week-num.is-today { color: var(--color-accent); }
.cust-week-date-label { font-size: 10px; color: var(--color-text-tertiary); margin-top: var(--space-1); }
...
.cust-week-card-top { display: flex; align-items: center; justify-content: space-between; gap: var(--space-1); margin-bottom: var(--space-1); }
...
.cust-week-card-info { font-size: 10px; color: var(--color-text-tertiary); display: flex; flex-wrap: wrap; gap: var(--space-1); margin-bottom: var(--space-1); }
