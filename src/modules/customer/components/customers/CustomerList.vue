  ...
  <div class="panel-card">
    <div class="panel-card-body">
      <div
        ...
        :key="c.id"
        class="list-item"
        :class="{ 'list-item-dormant': c.status === 'dormant' }"
        :style="{ animationDelay: idx * 50 + 'ms' }"
        @click="$emit('openDetail', c)"
      >
        <div class="list-item-check" @click.stop>
          <div class="checkbox" :class="{ checked: selectedIds.includes(c.id) }" @click="handleToggleSelect(c.id)">
            <Icon name="checkCircle" :size="14" />
          </div>
        </div>
        <div class="list-item-avatar" :style="{ background: levelColors[c.level] || '#94a3b8' }">
        ...
        <div class="list-item-actions" @click.stop>
          <button class="action-btn" title="编辑" @click="$emit('openEdit', c)"><Icon name="edit" :size="14" /></button>
