 ...
 * - storeName: Store 标识名
 * - storePath: Store 模块的导入路径（供 storeRegistry 动态加载）
...
export const entityRegistry = {
  customer: {
    dataKey: 'customers',
    storeName: 'customer',
    storePath: '@/modules/customer/stores/customer',
    tableName: 'customers',
  ...
  quotation: {
    dataKey: 'quotations',
    storeName: 'quotation',
    storePath: '@/modules/sales/stores/quotation',
  ...
  contract: {
    dataKey: 'contracts',
    storeName: 'contract',
    storePath: '@/modules/sales/stores/contract',
    tableName: 'contracts',
  ...
  inventory: {
    dataKey: 'inventory',
    storeName: 'inventory',
    storePath: '@/modules/warehouse/stores/inventory',
    tableName: 'inventory',
  ...
  collection: {
    ...
    storePath: '@/modules/finance/stores/collection',
  ...
  statement: {
    dataKey: 'statements',
    storeName: 'statement',
    storePath: '@/modules/finance/stores/statement',
  ...
  supplier: {
    dataKey: 'suppliers',
    storeName: 'supplier',
    storePath: '@/modules/purchase/stores/supplier',
    tableName: 'suppliers',
  ...
  warehouseLocation: {
    ...
    storePath: '@/modules/warehouse/stores/warehouseLocation',
  ...
  cost: {
    dataKey: 'records',
    storeName: 'cost',
    storePath: '@/modules/finance/stores/cost',
  ...
  transaction: {
    ...
    storePath: '@/modules/sales/stores/transaction',
  ...
  purchase: {
    ...
    storeName: 'purchase',
    storePath: '@/modules/purchase/stores/purchase',
  ...
  production: {
    ...
    storePath: '@/modules/production/stores/production',
  ...
  transfer: {
    ...
    storeName: 'transfer',
    storePath: '@/modules/warehouse/stores/transfer',
