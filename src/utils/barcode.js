import { CJK_SANS_FONT_STACK } from './fontStacks'
...
export function generateLabels(items, options = {}) {
  ...
  const labels = items.map((item) => {
    ...
    return `<div style="display:inline-block;width:${cfg.width}px;height:${cfg.height}px;border:1px solid #ccc;border-radius:4px;padding:5px;margin:3px;page-break-inside:avoid;font-family:${CJK_SANS_FONT_STACK}">
