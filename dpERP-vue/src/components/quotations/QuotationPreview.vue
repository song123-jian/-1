          ...
          <table class="ql-table">
            ...
            <tbody>
              ...
              <tr style="font-weight:bold;background:#f8f8f8">
                ...
                <td style="text-align:right">{{ (quotation.subtotal || 0).toFixed(2) }}</td>
                <td></td>
              </tr>
              <tr style="font-weight:bold;background:#f8f8f8">
                <td colspan="3" style="text-align:right">税额({{ quotation.taxRate || 13 }}%)</td>
                <td style="text-align:right">{{ ((quotation.subtotal || 0) * (quotation.taxRate || 13) / 100).toFixed(2) }}</td>
                <td></td>
              </tr>
              <tr style="font-weight:bold;background:#f0f0f0">
                <td colspan="3" style="text-align:right">含税合计</td>
                <td style="text-align:right;color:#c00">{{ (quotation.total || 0).toFixed(2) }}</td>
                <td></td>
              </tr>
            </tbody>
          </table>
