        ...
        <table class="data-table" style="font-size:var(--font-size-xs)">
          ...
          <tbody>
            <tr v-for="perm in permissionList" :key="perm.key">
              <td style="position:sticky;left:0;background:var(--color-surface-elevated);z-index:1;font-weight:600">{{ perm.label }}</td>
...
.role-badge { display: inline-block; padding: 1px 8px; background: var(--color-info-subtle); color: var(--color-info); border-radius: var(--radius-full); font-size: var(--font-size-xs); }
