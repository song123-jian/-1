...
.cal-day-customers { display: flex; flex-direction: column; gap: 2px; }
.cal-customer-chip { font-size: 10px; padding: 1px 6px; border-left: 3px solid var(--color-border); background: var(--color-surface-elevated); border-radius: 2px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; cursor: pointer; transition: background var(--transition-fast); }
...
.cal-selected-name { font-size: var(--font-size-sm); font-weight: 600; color: var(--color-text-primary); margin-bottom: 2px; }
.cal-selected-info { font-size: 10px; color: var(--color-text-tertiary); display: flex; flex-wrap: wrap; gap: 4px; margin-bottom: 2px; }
