<template>
  <span class="icon-wrap" v-html="svgHtml" :style="{ width: size + 'px', height: size + 'px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', verticalAlign: 'middle', flexShrink: '0' }"></span>
</template>
