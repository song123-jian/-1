        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-4)">
          <div>
            ...
            <div class="chart-container">
              <div v-if="revenueChartData.length === 0" style="text-align:center;color:var(--color-text-tertiary);padding:var(--space-4)">暂无数据</div>
          ...
          <div>
            ...
            <div class="chart-container">
              <div v-if="collectionChartData.length === 0" style="text-align:center;color:var(--color-text-tertiary);padding:var(--space-4)">暂无数据</div>
              <div v-else class="bar-chart">
