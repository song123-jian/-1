        ...
        <div class="panel-card-body no-padding">
          <div class="table-container">
            <table class="data-table">
              ...
              <tbody>
                <tr v-if="pagedContracts.length === 0"><td colspan="12" class="empty-state"><div class="empty-state-icon"><Icon name="file" :size="14" /></div>暂无合同数据</td></tr>
...
.stat-dot.signed { background: var(--color-success); }
.stat-dot.expiring { background: var(--color-warning); }
