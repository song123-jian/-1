...
const formatIcons = {
  pdf: '[文档]', doc: '[待办]', xls: '[数据]', ppt: '[演示]', jpg: '[图片]', png: '[图片]',
  zip: '[库存]', rar: '[库存]', dwg: '[布局]', other: '[附件]'
}
...
export const useArchiveStore = defineStore('archive', () => {
  ...
  const archiveRules = ref(safeGetJSON(RULES_KEY) || {
    remindHours: 72,
  ...
  function _persistArchives() { safeSetJSON(STORAGE_KEY, archives.value) }
  function _persistDownloadLogs() { safeSetJSON(DOWNLOAD_LOG_KEY, downloadLogs.value) }
  function _persistShareLogs() { safeSetJSON(SHARE_LOG_KEY, shareLogs.value) }
  function _persistAuditLogs() { safeSetJSON(AUDIT_LOG_KEY, auditLogs.value) }
  function _persistRecycleBin() { safeSetJSON(RECYCLE_KEY, recycleBin.value) }
  function _persistRules() { safeSetJSON(RULES_KEY, archiveRules.value) }
  ...
  function initSeedData() {
    ...
    const seeds = [
      { id: 'arc1', projectNo: 'PJ-2024-001', fileName: '产品规格书V2.0.pdf', category: '技术文件', subCategory: '物性表', version: '2.0', format: 'pdf', size: '2.3MB', status: 'approved', securityLevel: 'internal', tags: ['产品', '规格'], validUntil: '2026-12-31', uploader: '张工', createdAt: '2024-06-15' },
      { id: 'arc2', projectNo: 'PJ-2024-001', fileName: '购销合同-华达.pdf', category: '合同订单', subCategory: '框架合同', version: '1.0', format: 'pdf', size: '1.1MB', status: 'archived', securityLevel: 'confidential', tags: ['合同', '华达'], validUntil: '2025-06-30', uploader: '李经理', createdAt: '2024-05-20' },
      { id: 'arc3', projectNo: 'PJ-2024-002', fileName: '来料检验报告-0301.pdf', category: '测试报告', subCategory: '内部测试报告', version: '1.0', format: 'pdf', size: '0.8MB', status: 'pending_review', securityLevel: 'internal', tags: ['检验', '来料'], validUntil: '2025-03-31', uploader: '王质检', createdAt: '2024-07-01' },
      { id: 'arc4', projectNo: 'PJ-2024-003', fileName: '生产作业指导书.pdf', category: '技术文件', subCategory: '工艺文件', version: '3.1', format: 'pdf', size: '4.5MB', status: 'approved', securityLevel: 'internal', tags: ['生产', '作业'], validUntil: '2026-01-31', uploader: '赵工', createdAt: '2024-04-10' },
      { id: 'arc5', projectNo: 'PJ-2024-002', fileName: '报价单-华达2024Q3.xlsx', category: '报价单', subCategory: '初始报价单', version: '1.2', format: 'xls', size: '0.3MB', status: 'draft', securityLevel: 'public', tags: ['报价', '华达'], validUntil: '2024-12-31', uploader: '陈销售', createdAt: '2024-08-05' },
      { id: 'arc6', projectNo: 'PJ-2024-004', fileName: '质量手册2024版.pdf', category: '技术文件', subCategory: '技术标准', version: '4.0', format: 'pdf', size: '8.2MB', status: 'approved', securityLevel: 'confidential', tags: ['质量', '手册'], validUntil: '2026-12-31', uploader: '刘经理', createdAt: '2024-01-15' },
      { id: 'arc7', projectNo: 'PJ-2024-003', fileName: '产品图纸-装配图.dwg', category: '技术文件', subCategory: '图纸文件', version: '2.1', format: 'dwg', size: '12.5MB', status: 'approved', securityLevel: 'secret', tags: ['图纸', '装配'], validUntil: '2026-06-30', uploader: '张工', createdAt: '2024-03-22' },
      { id: 'arc8', projectNo: 'PJ-2024-001', fileName: '出货检验报告-0801.pdf', category: '测试报告', subCategory: '第三方检测报告', version: '1.0', format: 'pdf', size: '0.6MB', status: 'pending_review', securityLevel: 'internal', tags: ['检验', '出货'], validUntil: '2025-08-31', uploader: '王质检', createdAt: '2024-08-01' }
    ]
  ...
  return {
    ...
    saveRules, replaceData, initSeedData
  }
})
