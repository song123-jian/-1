...
export const useWarehouseLocationStore = defineStore('warehouseLocation', () => {
  ...
  function addLocation(data) {
    ...
    try { useInventoryStore().addAuditLog('create', 'warehouse', '新增库位: ' + item.locationCode) } catch(e) {}
    return item
  }
  ...
  function updateLocation(id, data) {
    ...
    persist(STORAGE_KEY, locations.value)
    try { useInventoryStore().addAuditLog('update', 'warehouse', '更新库位: ' + locations.value[idx].locationCode) } catch(e) {}
    return true
  }
  ...
  function deleteLocation(id) {
    ...
    persist(STORAGE_KEY, locations.value)
    try { useInventoryStore().addAuditLog('delete', 'warehouse', '删除库位: ' + locCode) } catch(e) {}
  }
