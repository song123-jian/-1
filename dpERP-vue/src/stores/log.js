...
export const useLogStore = defineStore('log', () => {
  ...
  const moduleLabels = {
    ...
    warehouse: '出入库', inbound: '入库', outbound: '出库',
    delivery: '送货管理', collections: '回款管理', statements: '对账管理',
    suppliers: '供应商', settings: '系统设置', approvals: '审批配置',
    sales_auth: '销售权限', archives: '档案管理', costanalysis: '成本核算',
    contracts: '合同管理', report: '报表'
  }
