...
function getDefaultTerms() {
  return {
    ...
    packaging: '按乙方生产厂家标准包装，包装须适于运输与储存；甲方有特殊包装要求的，应提前书面说明，增加费用由甲方承担；合理损耗按千分之三执行。',
    breach: '产品花色、规格、质量不符合约定时，甲方同意利用的按质论价，不同意利用的由乙方负责返工或换货；甲方未经乙方同意擅自变更产品规格、标准等产生的费用由甲方承担；乙方不承担甲方间接损失、预期利益损失、第三方赔偿责任等后果性损害。',
    dispute: '合同履行中发生争议，双方友好协商解决；协商不成，提交合同签订地人民法院诉讼解决。',
    validity: '本合同为一次性订单合同；采用本合同第五条C款结算的，自双方签字盖章之日起生效；其他交易可参照本合同条件另行书面约定。',
...
export const useContractStore = defineStore('contract', () => {
  ...
  const signedAmount = computed(() => contracts.value.filter(c => c.status === 'signed' || c.status === 'archived').reduce((s, c) => s + (c.totalAmount || 0), 0))
  ...
  function changeStatus(id, newStatus, extra) {
    ...
    persist()
    addHistoryEvent(id, newStatus === 'draft' && c.status === 'pending_approval' ? 'reject' : newStatus, c.contractNo + ' ' + (newStatus === 'draft' && c.status === 'pending_approval' ? '审批驳回' : '状态变更为' + (statusLabels[newStatus] || newStatus)))
    return true
  }
  ...
  function duplicateContract(id) {
    ...
    cloned.signDate = new Date().toISOString().split('T')[0]
    cloned.endDate = ''
    ...
    const seedContracts = [
      {
        ...
        partyA: '上海贸易有限公司', partyAId: 'c1',
        partyB: '苏州冠久新材料科技有限公司',
        signPlace: '苏州・高新区', signDate: '2026-01-15', endDate: '2026-12-31',
        settlement: '月结30天',
        products: [
          { productName: 'ABS树脂', spec: '通用级', quantity: 5000, unitPrice: 12.5, amount: 62500, deliveryPlace: '上海', remark: '' },
          { productName: 'POM塑料', spec: 'M90-44', quantity: 3000, unitPrice: 18.2, amount: 54600, deliveryPlace: '上海', remark: '' }
        ],
        totalAmount: 117100,
        terms: getDefaultTerms(),
        partyAInfo: { address: '上海市浦东新区', representative: '王经理', contact: '021-5555XXXX', date: '2026-01-15', seal: '' },
        partyBInfo: { companyName: '苏州冠久新材料科技有限公司', address: '苏州高新区滨河路3337号', representative: '宋建', contact: '15589233039', date: '2026-01-15', seal: 'preset' },
        status: 'signed', signedBy: '宋建', signedAt: '2026-01-15T10:00:00Z',
        sourceQuoteId: '', notes: '',
        createdAt: '2026-01-10T08:00:00Z', updatedAt: '2026-01-15T10:00:00Z'
      },
      {
        id: 'ct2', contractNo: 'HT202603001', contractType: '购销合同',
        partyA: '广州进出口有限公司', partyAId: 'c3',
        partyB: '苏州冠久新材料科技有限公司',
        signPlace: '苏州・高新区', signDate: '2026-03-01', endDate: '2027-02-28',
        settlement: '月结60天',
        products: [
          { productName: '不锈钢板304', spec: '2B/BA', quantity: 8000, unitPrice: 25.0, amount: 200000, deliveryPlace: '广州', remark: '' },
          { productName: '铝合金型材6063', spec: 'T5', quantity: 5000, unitPrice: 22.0, amount: 110000, deliveryPlace: '广州', remark: '' }
        ],
        totalAmount: 310000,
        terms: getDefaultTerms(),
        partyAInfo: { address: '广州市天河区', representative: '李总', contact: '020-3888XXXX', date: '2026-03-01', seal: '' },
        partyBInfo: { companyName: '苏州冠久新材料科技有限公司', address: '苏州高新区滨河路3337号', representative: '宋建', contact: '15589233039', date: '2026-03-01', seal: 'preset' },
        status: 'pending_approval', submittedBy: '宋建', submittedAt: '2026-03-01T09:00:00Z',
        sourceQuoteId: '', notes: '大客户年度框架合同',
        createdAt: '2026-02-25T08:00:00Z', updatedAt: '2026-03-01T09:00:00Z'
      },
      {
        id: 'ct3', contractNo: 'HT202604001', contractType: '采购合同',
        partyA: '苏州冠久新材料科技有限公司', partyAId: '',
        partyB: '江苏钢铁集团有限公司',
        signPlace: '苏州・高新区', signDate: '2026-04-10', endDate: '2026-10-10',
        settlement: '款到发货',
        products: [
          { productName: '碳钢Q235', spec: '热轧板卷', quantity: 20000, unitPrice: 4.5, amount: 90000, deliveryPlace: '苏州', remark: '' }
        ],
        totalAmount: 90000,
        terms: getDefaultTerms(),
        partyAInfo: { address: '苏州高新区滨河路3337号', representative: '宋建', contact: '15589233039', date: '2026-04-10', seal: 'preset' },
        partyBInfo: { companyName: '江苏钢铁集团有限公司', address: '江苏省', representative: '周经理', contact: '0512-5333XXXX', date: '2026-04-10', seal: '' },
        status: 'approved', approvedBy: '总经理', approvedAt: '2026-04-12T14:00:00Z',
        sourceQuoteId: '', notes: '',
        createdAt: '2026-04-08T08:00:00Z', updatedAt: '2026-04-12T14:00:00Z'
      },
      {
        id: 'ct4', contractNo: 'HT202605001', contractType: '购销合同',
        partyA: '北京科技发展集团', partyAId: 'c2',
        partyB: '苏州冠久新材料科技有限公司',
        signPlace: '苏州・高新区', signDate: '2026-05-20', endDate: '2026-08-20',
        settlement: '货到付款',
        products: [
          { productName: '轴承钢GCr15', spec: 'Φ50', quantity: 2000, unitPrice: 35.0, amount: 70000, deliveryPlace: '北京', remark: '' }
        ],
        totalAmount: 70000,
        terms: getDefaultTerms(),
        partyAInfo: { address: '北京市海淀区', representative: '张总', contact: '010-6666XXXX', date: '2026-05-20', seal: '' },
        partyBInfo: { companyName: '苏州冠久新材料科技有限公司', address: '苏州高新区滨河路3337号', representative: '宋建', contact: '15589233039', date: '2026-05-20', seal: 'preset' },
        status: 'draft',
        sourceQuoteId: 'q3', notes: '由报价单QT20241201001转入',
        createdAt: '2026-05-18T08:00:00Z', updatedAt: '2026-05-18T08:00:00Z'
      },
      {
        id: 'ct5', contractNo: 'HT202605002', contractType: '框架协议',
        partyA: '深圳智能制造有限公司', partyAId: 'c4',
        partyB: '苏州冠久新材料科技有限公司',
        signPlace: '苏州・高新区', signDate: '2026-05-01', endDate: '2027-04-30',
        settlement: '月结90天',
        products: [],
        totalAmount: 500000,
        terms: getDefaultTerms(),
        partyAInfo: { address: '深圳市南山区', representative: '刘总', contact: '0755-2222XXXX', date: '2026-05-01', seal: '' },
        partyBInfo: { companyName: '苏州冠久新材料科技有限公司', address: '苏州高新区滨河路3337号', representative: '宋建', contact: '15589233039', date: '2026-05-01', seal: 'preset' },
        status: 'archived',
        sourceQuoteId: '', notes: '年度框架协议',
        createdAt: '2026-04-20T08:00:00Z', updatedAt: '2026-05-25T16:00:00Z'
      }
    ]
    ...
    const seedTemplates = [
      {
        ...
        settlement: '月结30天',
        terms: getDefaultTerms(),
        partyBInfo: { companyName: '苏州冠久新材料科技有限公司', address: '苏州高新区滨河路3337号', representative: '宋建', contact: '15589233039', date: '', seal: 'preset' },
      ...
      },
      {
        ...
        products: [{ productName: '', spec: '', quantity: 0, unitPrice: 0, amount: 0, deliveryPlace: '苏州', remark: '' }]
      },
      {
        id: 'tpl_seed_3',
        name: '框架协议（年度合作）',
        ...
        terms: {
          ...getDefaultTerms(),
          validity: '本协议有效期为一年，自双方签字盖章之日起生效；协议期满前30日内，如双方无异议，自动续期一年；具体订单以双方书面确认为准。',
          settlement: '采用${结算方式}结算方式，每月25日对账，次月15日前付清上月货款。',
          breach: '任何一方未按协议约定履行义务的，应承担违约责任，赔偿对方因此遭受的直接经济损失；连续两次违约的，守约方有权单方解除协议。'
        },
        partyBInfo: { companyName: '苏州冠久新材料科技有限公司', address: '苏州高新区滨河路3337号', representative: '宋建', contact: '15589233039', date: '', seal: 'preset' },
        products: [{ productName: '', spec: '', quantity: 0, unitPrice: 0, amount: 0, deliveryPlace: '', remark: '按订单执行' }]
      }
    ]
  ...
  return {
    contracts, templates,
    draftCount, pendingApprovalCount, approvedCount, signedCount, archivedCount, cancelledCount,
    totalAmount, signedAmount, expiringCount, expiredCount,
    statusCounts, settlementCounts, typeCounts, customerTopList, monthlyAmounts,
    addContract, updateContract, deleteContract,
    batchDelete, changeStatus, duplicateContract, getContractById,
    getHistory, addHistoryEvent,
