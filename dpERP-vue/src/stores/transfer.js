...
export const useTransferStore = defineStore('transfer', () => {
    ...
    transferOrders.value = [
      {
        ...
        status: 'completed',
        items: [
          { id: generateId('dbi'), materialCode: 'MTL-001', materialName: 'ABS树脂', spec: '通用级', unit: 'kg', quantity: 100, unitPrice: 85.5, amount: 8550 },
          { id: generateId('dbi'), materialCode: 'MTL-007', materialName: '碳钢Q235', spec: '热轧板卷', unit: 'kg', quantity: 200, unitPrice: 45, amount: 9000 }
        ],
        totalAmount: 17550,
        requester: '仓管员',
        approver: '仓库主管',
      ...
      },
      {
        ...
        status: 'in_transit',
        items: [
          { id: generateId('dbi'), materialCode: 'MTL-002', materialName: '不锈钢板304', spec: '2B/BA', unit: 'kg', quantity: 300, unitPrice: 125, amount: 37500 }
        ],
        totalAmount: 37500,
        requester: '仓管员',
        approver: '仓库主管',
      ...
      },
      {
        ...
        status: 'pending',
        items: [
          { id: generateId('dbi'), materialCode: 'MTL-003', materialName: '铝合金型材6063', spec: 'T5', unit: 'kg', quantity: 150, unitPrice: 95, amount: 14250 },
          { id: generateId('dbi'), materialCode: 'MTL-004', materialName: 'POM塑料', spec: 'M90-44', unit: 'kg', quantity: 80, unitPrice: 65, amount: 5200 }
        ],
        totalAmount: 19450,
        requester: '仓管员',
        approver: '',
  ...
  function approveTransferOrder(id, approver) {
    ...
    transferOrders.value[idx].approveDate = new Date().toISOString().split('T')[0]
    persist()
    return true
  }
