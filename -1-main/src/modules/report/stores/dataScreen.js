  ...
  const salesCards = computed(() => [
    {
      ...
      color: '#00d4ff',
      format: 'currency',
      sparkline: salesTrend.value.data.slice(-7)
    },
    {
      title: '本月销售额',
    ...
    },
    {
      ...
      color: '#ffa940',
      format: 'number',
      sparkline: salesTrend.value.data.slice(-7).map((v) => Math.round(v / 1000))
    },
    {
      title: '活跃客户数',
      ...
      color: '#722ed1',
      format: 'number',
      sparkline: [3, 5, 4, 7, 6, 8, activeCustomerCount.value]
    }
  ])
  ...
  const inventoryCards = computed(() => [
    {
      ...
      color: '#1890ff',
      format: 'number',
      sparkline: inoutTrend.value.inbound.slice(-7)
    },
    {
      title: '低库存数',
      ...
      color: '#faad14',
      format: 'number',
      sparkline: [5, 3, 4, 6, 5, 4, lowStockCount.value]
    },
    {
      title: '耗尽数',
      ...
      color: '#ff4d4f',
      format: 'number',
      sparkline: [2, 1, 3, 2, 1, 2, exhaustedCount.value]
    },
    {
      title: '库存总值',
      ...
      color: '#13c2c2',
      format: 'currency',
      sparkline: inoutTrend.value.inbound.slice(-7).map((v) => v * 100)
    }
  ])
  ...
  const financeCards = computed(() => [
    {
      ...
      color: '#eb2f96',
      format: 'currency',
      sparkline: salesTrend.value.data.slice(-7).map((v) => v * 0.3)
    },
    {
      title: '应付总额',
      ...
      color: '#fa8c16',
      format: 'currency',
      sparkline: salesTrend.value.data.slice(-7).map((v) => v * 0.2)
    },
    {
      title: '本月回款',
      ...
      color: '#52c41a',
      format: 'currency',
      sparkline: salesTrend.value.data.slice(-7).map((v) => v * 0.5)
    },
    {
      title: '利润率',
      ...
      color: '#2f54eb',
      format: 'percent',
      sparkline: [12, 15, 13, 16, 14, 17, profitMargin.value]
    }
  ])
