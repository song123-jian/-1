    ...
    <div class="scene-sales__body">
      <div class="scene-sales__left">
        <TechBorder color="#00d4ff">
          <div class="scene-sales__panel">
            <div class="scene-sales__panel-title">
              <span class="panel-dot"></span>
              销售趋势（近12月）
            </div>
            <div ref="salesTrendRef" class="scene-sales__chart"></div>
          </div>
        </TechBorder>
        <TechBorder color="#722ed1">
          <div class="scene-sales__panel">
            <div class="scene-sales__panel-title">
              <span class="panel-dot" style="background: #722ed1"></span>
              客户维度分析
            </div>
            <div ref="radarRef" class="scene-sales__chart"></div>
          </div>
        </TechBorder>
      </div>
      <div class="scene-sales__center">
        <TechBorder color="#00d4ff">
          <div class="scene-sales__panel">
            ...
            <div ref="mapRef" class="scene-sales__chart"></div>
          </div>
        </TechBorder>
      </div>
      <div class="scene-sales__right">
        ...
        <RankPanel
          title="客户贡献 Top10"
          :items="
            dataScreenStore.topCustomers.map((c, i) => ({
              name: c.name || c.fullName,
              value: Math.round(c.balance || 0),
              rank: i + 1
            }))
          "
        />
...
<script>
export default { name: 'SalesScene' }
</script>
<script setup>
